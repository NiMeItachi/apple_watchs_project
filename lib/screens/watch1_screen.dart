...
class Watch1Page extends StatefulWidget {
  static const String id = "watch1_page";

  const Watch1Page({Key? key}) : super(key: key);

  @override
  State<Watch1Page> createState() => _Watch1PageState();
}

class _Watch1PageState extends State<Watch1Page> {
  @override
